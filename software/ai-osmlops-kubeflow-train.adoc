...
image:kubeflow-pipeline.png[Kubeflow Pipeline Run Visualization]
...
image:tensorboard-graph.png[Tensorboard graph for training loss and accuracy]
...
image:katib-experiment-001.png[Katib Experiment Dashboard with hyperparameters]

image:katib-experiment-002.png[Successful trial check]
...
image:kubeflow-snapshot.png[Code to build a Snapshot pipeline in Kubeflow]
...
// NetApp Solutions restructuring (jul 2025) - renamed from ai/aicp_kubeflow_train_image_recognition.adoc
