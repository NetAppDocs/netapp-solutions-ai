...
summary: Learn how KV cache offloading to CPU memory and shared NetApp StorageGRID S3 or ONTAP NFS/pNFS storage reduces repeated prefill work and enables cache reuse across vLLM instances.
---
...
image:kv-cache-002.png["Multi-round inference benchmark",600,600]
