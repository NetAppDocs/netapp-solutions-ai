...
image:ddlnexus-004.png["Figure showing input/output dialog or representing written content"]

==== After Exposing FlexCache Volume to Domino

image:ddlnexus-005.png["Figure showing input/output dialog or representing written content"]
...
// NetApp Solutions restructuring (jul 2025) - renamed from ai/ddlnexus_access_data_hybrid.adoc
