...
For additional use cases for edge computing and AI inferencing across other industries, see link:../infra/ai-lenovo-edge-intro.html[TR-4886 AI Inferencing at the Edge^] and the NetApp AI blog, https://www.netapp.com/blog/federated-learning-intelligence-vs-privacy/[Intelligence versus privacy^].



// NetApp Solutions restructuring (jul 2025) - renamed from ai/ai-protopia-solution-areas.adoc
