...
Before you deploy JupyterHub, you must designate a default StorageClass within your Kubernetes cluster. To designate a default StorageClass within your cluster, follow the instructions outlined in the link:ai-osmlops-kubeflow-deploy.html[Kubeflow Deployment] section. If you have already designated a default StorageClass within your cluster, then you can skip this step.
...
// NetApp Solutions restructuring (jul 2025) - renamed from ai/aicp_jupyterhub_deployment.adoc
