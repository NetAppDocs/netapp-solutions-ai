...
+
image:ai-protopia-003.png["Figure showing input/output dialog or representing written content"]
...
+
image:ai-protopia-004.png["Figure showing input/output dialog or representing written content"]

. Return to the top-level directory and create a new notebook.
+
image:ai-protopia-005.png["Figure showing input/output dialog or representing written content"]

. Add inferencing code to the notebook. The following example shows inferencing code for an image detection use case.
+
image:ai-protopia-006.png["Figure showing input/output dialog or representing written content"]
+
image:ai-protopia-007.png["Figure showing input/output dialog or representing written content"]
...
+
image:ai-protopia-008.png["Figure showing input/output dialog or representing written content"]
+
image:ai-protopia-009.png["Figure showing input/output dialog or representing written content"]
...
+
We repeated this step for ALPHA values 0.05, 0.1, 0.2, 0.4, 0.6, 0.8, 0.9, and 0.95. You can see the results in link:ai-conf-protopia-accuracy.html["Inferencing accuracy comparison."]
+
....
...
// NetApp Solutions restructuring (jul 2025) - renamed from ai/ai-protopia-test-procedure.adoc
