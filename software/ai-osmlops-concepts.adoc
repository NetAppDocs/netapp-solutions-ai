...
image:aicp-002.png["Figure showing input/output dialog or representing written content"]
...
image:aicp-004.png["Figure showing input/output dialog or representing written content"]
...
image:aicp-005.png["Figure showing input/output dialog or representing written content"]
...
image:aicp-007.png["Figure showing input/output dialog or representing written content"]


// NetApp Solutions restructuring (jul 2025) - renamed from ai/aicp_concepts_and_components.adoc
