...
summary: Deploy a hybrid AI training environment using Union.ai orchestration with NetApp FlexCache to enable cloud-based GPU training workloads to access on-premises data efficiently and securely.
---
...
✅ Use correct ONTAP credentials (e.g., vsadmin)
...
image::ai-hybrid-union-001.png["Hybrid AI training architecture with Union.ai and NetApp"]
...
🔗
https://docs.netapp.com/us-en/trident/trident-install/kubernetes-deploy-operator.html[+++Trident
Installation Guide+++]
...
View logs in the https://console.union.ai[+++Union UI+++]
