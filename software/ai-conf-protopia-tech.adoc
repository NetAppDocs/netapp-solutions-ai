...
image:ai-protopia-002.png["Figure showing input/output dialog or representing written content"]
...
// NetApp Solutions restructuring (jul 2025) - renamed from ai/ai-protopia-technology-overview.adoc
