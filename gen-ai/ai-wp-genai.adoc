...
image:gen-ai-001.png["Figure 1: Use cases driving Generative AI"]
...
image:gen-ai-004.png[Figure 3: Problem Types]
...
image:gen-ai-006.png[Figure 3: Machine Learning/Large Language Model Workflow]
...
image:gen-ai-007.png[Figure 4: Generative AI-LLM data pipeline]
...
// NetApp Solutions restructuring (jul 2025) - renamed from ai/wp-genai.adoc
