...
image:perf-mivus-standalone.png["Figure showing input/output dialog or representing written content"]
...
image:vector-db-result-standalone.png["Figure showing input/output dialog or representing written content"]
...
image:milvus-vmware-perf.png["Figure showing input/output dialog or representing written content"]
image:milvus-cluster-perf.png["Figure showing input/output dialog or representing written content"]
...
image:milvus-standalone-cluster-perf.png["Figure showing input/output dialog or representing written content"]
...
image:storagecluster-latency-iops-milcus.png["Figure showing input/output dialog or representing written content"]
...
image:pgvecto-perf-network-connectivity.png["Figure showing input/output dialog or representing written content"]
...
image:pgvecto-storage-iops-latency.png["Figure showing input/output dialog or representing written content"]

 The following section presents the key storage performance metrics.

image:pgvecto-storage-perf-metrics.png["Figure showing input/output dialog or representing written content"]

=== Performance comparison between milvus and postgres on vector DB Bench

image:perf-comp-milvus-postgres.png["Figure showing input/output dialog or representing written content"]
...
// NetApp Solutions restructuring (jul 2025) - renamed from ai/vector-database-performance-validation.adoc
