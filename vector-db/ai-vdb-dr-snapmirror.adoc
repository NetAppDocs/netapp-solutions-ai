...
image:vector-database-dr-fsxn-gcnv.png["Figure showing input/output dialog or representing written content"]
...
// NetApp Solutions restructuring (jul 2025) - renamed from ai/vector-database-disaster-recovery-using-netapp-snapmirror.adoc
