...
image:rag-nvidia-nemo.png["Figure showing input/output dialog or representing written content"]
...
image:netapp-chatbot.png["Figure showing input/output dialog or representing written content"]
...
// NetApp Solutions restructuring (jul 2025) - renamed from ai/vector-database-use-cases.adoc
