...
image:milvus-architecture-with-netapp.png["Figure showing input/output dialog or representing written content"] 
...
// NetApp Solutions restructuring (jul 2025) - renamed from ai/vector-database-vector-database.adoc
