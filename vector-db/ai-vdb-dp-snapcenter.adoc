...
+
image:sc-host-setup.png["Figure showing input/output dialog or representing written content"] 
+
...
+
image:sc-storage-plugin.png["Figure showing input/output dialog or representing written content"]
+
...
+
image:sc-storage-system.png["Figure showing input/output dialog or representing written content"]
+
...
+
image:sc-resource-vectordatabase.png["Figure showing input/output dialog or representing written content"]
+
...
+
image:sc-backup-vector-database.png["Figure showing input/output dialog or representing written content"]
...
+
image:sc-restore-vector-database.png["Figure showing input/output dialog or representing written content"]
+
...
// NetApp Solutions restructuring (jul 2025) - renamed from ai/vector-database-protection-using-snapcenter.adoc
