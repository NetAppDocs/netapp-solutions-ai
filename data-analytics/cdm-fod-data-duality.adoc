...
. Create a new working environment, select the cloud provider, and select the type of Cloud Volumes ONTAP instance, (such as single-CVO, HA, or Amazon FSx ONTAP for ONTAP).
...
+
image:cdm-fod-002.png["Screenshot depicting the step."]
+
image:cdm-fod-003.png["Screenshot depicting the step."]

. Start the AWS Notebook.
+
image:cdm-fod-004.png["Screenshot depicting the step."]

. Open the Jupyter lab.
+
image:cdm-fod-005.png["Screenshot depicting the step."]
...
// NetApp Solutions restructuring (jul 2025) - renamed from data-analytics/cdm-fod-data-duality-for-data-scientists-and-other-applications.adoc
