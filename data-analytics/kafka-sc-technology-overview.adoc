...
image:kafka-sc-004.png[This graphic shows the application accessing an S3 bucket.]
...
image:kafka-sc-005.png[This graphic shows the ONTAP System Manager workspace.]
...
image:kafka-sc-006.png[This graphic shows the components of Confluent Platform.]
