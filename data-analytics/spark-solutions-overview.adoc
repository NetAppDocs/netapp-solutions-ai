...
image:apache-spark-004.png[The data fabric provides data management services and applications.]
...
image:apache-spark-005.png[Spark solution with NetApp storage.]
...
image:apache-spark-007.png[NetApp Apache Spark/Hadoop storage positioning.]
...
image:apache-spark-009.png[Recommended NetApp solutions for Spark.]
...
// NetApp Solutions restructuring (jul 2025) - renamed from data-analytics/apache-spark-netapp-spark-solutions-overview.adoc
