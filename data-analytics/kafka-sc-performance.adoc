...
image:kafka-sc-009.png[This data graph shows combined S3 tiering traffic with five or eight broker nodes.]

The following graph shows the Kafka throughput at approximately 31.74GBps. 

image:kafka-sc-010.png[This data graph shows the Kafka throughput at approximately 31.74GBps.]
...
// NetApp Solutions restructuring (jul 2025) - renamed from data-analytics/kafka-sc-performance-tests-with-produce-consume-workload-generator.adoc
