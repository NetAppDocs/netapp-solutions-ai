...
image:apache-spark-014.png[Example solution of a cloud service partner.]
...
// NetApp Solutions restructuring (jul 2025) - renamed from data-analytics/apache-spark-hybrid-cloud-solution.adoc
