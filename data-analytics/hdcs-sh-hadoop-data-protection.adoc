...
image:hdcs-sh-004.png["Figure showing input/output dialog or representing written content"]



// NetApp Solutions restructuring (jul 2025) - renamed from data-analytics/hdcs-sh-hadoop-data-protection-and-netapp.adoc
