...
image:stgr-splunkss-005.png["Figure showing input/output dialog or representing written content"]
...
image:stgr-splunkss-006.png["Figure showing input/output dialog or representing written content"]

This figure depicts an example of a multisite distributed deployment.

image:stgr-splunkss-007.png["Figure showing input/output dialog or representing written content"]
...
image:stgr-splunkss-008.png["Figure showing input/output dialog or representing written content"]
...
image:stgr-splunkss-009.png["Figure showing input/output dialog or representing written content"]
...
// NetApp Solutions restructuring (jul 2025) - renamed from data-analytics/stgr-splunkss-splunk-architecture.adoc
