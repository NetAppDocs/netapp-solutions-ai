...
Instaclustr supports Kafka Connect Connectors and their details - link:https://github.com/instaclustr/kafka-connect-connectors[More details]. Instaclustr provides additional connectors link:https://www.instaclustr.com/support/documentation/kafka-connect/bundled-kafka-connect-plugins/[their details]
