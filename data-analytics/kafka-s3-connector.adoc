...
Instaclustr supports Kafka Connect Connectors and their details - link:https://github.com/instaclustr/kafka-connect-connectors[More details]. Instacliustr provides additional connectors link:https://www.instaclustr.com/support/documentation/kafka-connect/bundled-kafka-connect-plugins/[their details]

// NetApp Solutions restructuring (jul 2025) - renamed from data-analytics/confluent-kafka-kafka-s3-connector.adoc
