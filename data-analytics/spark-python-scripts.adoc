---
sidebar: sidebar
permalink: data-analytics/spark-python-scripts.html
keywords:
summary:
---
...
// NetApp Solutions restructuring (jul 2025) - renamed from data-analytics/apache-spark-python-scripts-for-each-major-use-case.adoc
