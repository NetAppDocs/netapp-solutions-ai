...
image:hdcs-sh-013.png["Figure showing input/output dialog or representing written content"]
...
// NetApp Solutions restructuring (jul 2025) - renamed from data-analytics/hdcs-sh-use-case-5-accelerate-analytic-workloads.adoc
