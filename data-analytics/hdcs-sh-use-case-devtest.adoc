...
image:hdcs-sh-011.png["Figure showing input/output dialog or representing written content"]


// NetApp Solutions restructuring (jul 2025) - renamed from data-analytics/hdcs-sh-use-case-3-enabling-devtest-on-existing-hadoop-data.adoc
