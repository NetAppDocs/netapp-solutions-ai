...
image:hdcs-sh-012.png["Figure showing input/output dialog or representing written content"]
...
// NetApp Solutions restructuring (jul 2025) - renamed from data-analytics/hdcs-sh-use-case-4-data-protection-and-multicloud-connectivity.adoc
