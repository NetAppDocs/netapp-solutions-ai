...
image:hdcs-sh-001.png["Figure showing input/output dialog or representing written content"]
...
image:hdcs-sh-002.png["Figure showing input/output dialog or representing written content"]
...
image:hdcs-sh-003.png["Figure showing input/output dialog or representing written content"]
...
// NetApp Solutions restructuring (jul 2025) - renamed from data-analytics/hdcs-sh-data-fabric-powered-by-netapp-for-big-data-architecture.adoc
