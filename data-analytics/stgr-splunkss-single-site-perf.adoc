...
image:stgr-splunkss-010.png["Figure showing input/output dialog or representing written content"]
...
image:stgr-splunkss-011.png["Figure showing input/output dialog or representing written content"]
...
image:stgr-splunkss-012.png["Figure showing input/output dialog or representing written content"]
...
image:stgr-splunkss-013.png["Figure showing input/output dialog or representing written content"]

We collected the performance information from the cluster master. The peak performance was 61.34GBps.

image:stgr-splunkss-014.png["Figure showing input/output dialog or representing written content"]

The average performance was approximately 29GBps.

image:stgr-splunkss-015.png["Figure showing input/output dialog or representing written content"]
...
image:stgr-splunkss-016.png["Figure showing input/output dialog or representing written content"]
...
image:stgr-splunkss-017.png["Figure showing input/output dialog or representing written content"]
...
image:stgr-splunkss-018.png["Figure showing input/output dialog or representing written content"]
