...
image:kafka-nfs-032.png["Figure showing input/output dialog or representing written content"]
...
image:kafka-nfs-033.png[This graph shows Broker Network Throughput.]
...
image:kafka-nfs-034.png[This graph shows Broker Network Throughput.]
...
image:kafka-nfs-035.png["Figure showing input/output dialog or representing written content"]
...
// NetApp Solutions restructuring (jul 2025) - renamed from data-analytics/kafka-nfs-performance-overview-and-validation-with-aff-on-premises.adoc
