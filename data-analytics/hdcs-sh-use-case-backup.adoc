...
image:hdcs-sh-005.png["Figure showing input/output dialog or representing written content"]
...
image:hdcs-sh-006.png["Figure showing input/output dialog or representing written content"]
...
image:hdcs-sh-007.png["Figure showing input/output dialog or representing written content"]
...
image:hdcs-sh-008.png["Figure showing input/output dialog or representing written content"]
...
// NetApp Solutions restructuring (jul 2025) - renamed from data-analytics/hdcs-sh-use-case-1-backing-up-hadoop-data.adoc
