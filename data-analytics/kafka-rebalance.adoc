...
Instaclustr also supports self-rebalancing features and has been implemented for multiple customers. 
// NetApp Solutions restructuring (jul 2025) - renamed from data-analytics/confluent-kafka-confluent-kafka-rebalance.adoc
