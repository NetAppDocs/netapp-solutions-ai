...
image:bda-ai-001.png["Figure showing input/output dialog or representing written content"]
...
image:bda-ai-002.png["Figure showing input/output dialog or representing written content"]
