...
image:kafka-nfs-008.png["This image depicts the interaction of OpenMessaging clients with a Kafka cluster."]
...
image:kafka-nfs-009.png["This image depicts the specifications selected for the Kafka brokers."]
...
image:kafka-nfs-010.png["This image depicts the specifications selected for the OpenMessaging benchmark workload configuration."]
...
image:kafka-nfs-011.png["This graph depicts the behavior of a DAS-based cluster."]

image:kafka-nfs-012.png["This graph depicts the behavior of an NFS-based cluster."]

Also, at 100,000 messages,  DAS shows more CPU utilization than an NFS cluster.

image:kafka-nfs-013.png["This graph depicts the behavior of a DAS-based cluster at 100,000 messages."]

image:kafka-nfs-014.png["This graph depicts the behavior of an NFS-based cluster at 100,000 messages."]
...
image:kafka-nfs-008.png["This figure depicts the architecture of an NAS-based Kafka cluster."]
...
image:kafka-nfs-015.png["This image shows the specifications chosen for the Kafka brokers."]
...
+
image:kafka-nfs-016.png[This image shows two terminal screens.]
...
+
image:kafka-nfs-021.png["This graph shows the Time taken for broker recovery depending on the amount of data loaded on the broker for either a DAS-based cluster or an NFS-based cluster."]
...
image:kafka-nfs-022.png["This image depicts space savings in VMDISK."]
...
// NetApp Solutions restructuring (jul 2025) - renamed from data-analytics/kafka-nfs-why-netapp-nfs-for-kafka-workloads.adoc
