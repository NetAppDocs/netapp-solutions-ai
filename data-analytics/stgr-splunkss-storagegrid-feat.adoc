...
image:stgr-splunkss-003.png["Figure showing input/output dialog or representing written content"]
...
image:stgr-splunkss-004.png["Figure showing input/output dialog or representing written content"]
...
// NetApp Solutions restructuring (jul 2025) - renamed from data-analytics/stgr-splunkss-flexible-storagegrid-features.adoc
