...
image:hdcs-sh-009.png["Figure showing input/output dialog or representing written content"]
...
image:hdcs-sh-010.png["Figure showing input/output dialog or representing written content"]



// NetApp Solutions restructuring (jul 2025) - renamed from data-analytics/hdcs-sh-use-case-2-backup-and-disaster-recovery-from-the-cloud-to-on-premises.adoc
