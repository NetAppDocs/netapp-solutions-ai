...
image:confluent-kafka-004.png["Figure showing input/output dialog or representing written content"]
...
image:confluent-kafka-005.png["Figure showing input/output dialog or representing written content"]
...
image:confluent-kafka-006.png["Figure showing input/output dialog or representing written content"]
...
// NetApp Solutions restructuring (jul 2025) - renamed from data-analytics/confluent-kafka-technology-overview.adoc
