...
== Prerequisite
=== Network Environment
image:mlops-fsxn-sagemaker-integration-training-002.png[Network environment]
...
The data reading process involves configuring FSx ONTAP as a private S3 bucket. To learn the detailed configuration instructions, please refer to link:ai-mlops-fsxn-s3.html[Part 1 - Integrating Amazon FSx for NetApp ONTAP (FSx ONTAP)) as a private S3 bucket into AWS SageMaker]

== Integration Overview
image:mlops-fsxn-sagemaker-integration-training-001.png[Training workflow]
...
// NetApp Solutions restructuring (jul 2025) - renamed from ai/mlops_fsxn_sagemaker_integration_training.adoc
