...
+
image:mlops-fsxn-s3-integration-021.png[Open AWS console]
. Open the *Notebook instances* under Notebook tab, click the orange button *Create notebook instance*.
+
image:mlops-fsxn-s3-integration-001.png[AWS SageMaker Notebook Instance console]
...
+
image:mlops-fsxn-s3-integration-002.png[Create notebook instance]
...
+
image:mlops-fsxn-s3-integration-004.png[Create file system]
. Select the first card *FSx ONTAP* and click *Next*.
+
image:mlops-fsxn-s3-integration-005.png[Select file system type]
. In the details configuration page.
.. Select the *Standard create* option.
+
image:mlops-fsxn-s3-integration-006.png[Create file system panel]
.. Enter the *File system name* and the *SSD storage capacity*.
+
image:mlops-fsxn-s3-integration-007.png[Specify file system details]
.. Make sure to use the *VPC* and *subnet* same to the *SageMaker Notebook* instance.
+
image:mlops-fsxn-s3-integration-008.png[Network & security configuration]
.. Enter the *Storage virtual machine* name and *Specify a password* for your SVM (storage virtual machine).
+
image:mlops-fsxn-s3-integration-009.png[Default storage virtual machine configuration]
.. Leave other entries default and click the orange button *Next* at the bottom right.
+
image:mlops-fsxn-s3-integration-010.png[Confirm configuration]
.. Click the orange button *Create file system* at the bottom right of the review page.
+
image:mlops-fsxn-s3-integration-011.png[Review configuration and confirm creation]
. It may takes about *20-40 minutes* to spin up the FSx file system.
+
image:mlops-fsxn-s3-integration-012.png[Inspect the FSx console]

=== Server Configuration
==== ONTAP Configuration
. Open the created FSx file system. Please make sure the status is *Available*.
+
image:mlops-fsxn-s3-integration-013.png[Wait for the backend creation]
. Select the *Administration* tab and keep the *Management endpoint - IP address* and *ONTAP administrator username*.
+
image:mlops-fsxn-s3-integration-014.png[File system detail console]
. Open the created *SageMaker Notebook instance* and click *Open JupyterLab*.
+
image:mlops-fsxn-s3-integration-015.png[AWS SageMaker Notebook instance console]
. In the Jupyter Lab page, open a new *Terminal*.
+
image:mlops-fsxn-s3-integration-016.png[Jupyter Lab welcome page]
...
----
+
image:mlops-fsxn-s3-integration-018.png[Jupyter Lab terminal output]
...
+
image:mlops-fsxn-s3-integration-020.png[Open a new Jupyter notebook]
...
// NetApp Solutions restructuring (jul 2025) - renamed from ai/mlops_fsxn_s3_integration.adoc
