...
summary: Lustre with NetApp E-Series Storage - Solution architecture, building block design, scaling rules, network topology, and client integration for EF80 and other supported platforms.
---
...
[.lead]
This section describes the building block architecture, scaling model, high availability design, network topology, and client integration for Lustre with NetApp E-Series Storage.
...
The figure below shows up to five building blocks stacked in a 42U rack (one Pacemaker HA cluster per rack). Multiple racks can participate in a single Lustre file system; only the base building block hosts the MGS.

_Lustre parallel file system — rack scaling_
