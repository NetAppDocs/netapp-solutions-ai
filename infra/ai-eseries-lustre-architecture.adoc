...
NetApp publishes pre-built Lustre packages for server nodes only. NetApp recommends building client packages from source RPMs (SRPMs) in the link:https://github.com/NetApp/netapp-lustre/tree/master/repo/lustre[netapp-lustre repository^] for a client operating system listed in the Lustre Support Matrix.
