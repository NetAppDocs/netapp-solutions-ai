...
image:a400-thinksystem-002.png[This image depicts an Ethernet switch surrounded by the management server, four SR670 V2s with eight GPUs each and a NetApp ONTAP storage system.]
...
// NetApp Solutions restructuring (jul 2025) - renamed from ai/a400-thinksystem-introduction.adoc
