...
Refer to the https://docs.netapp.com/us-en/trident/trident-install/kubernetes-deploy-operator.html[Trident installation documentation^] for further details.
