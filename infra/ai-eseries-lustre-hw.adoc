...
| Network HCAs
| 6 dual-port 200Gb HCAs (see <<platform-connectivity,HCA connectivity>>)

| PCIe slots
| 2× PCIe Gen5 x16 and 4× PCIe Gen5 x8 (see <<pcie-slots,PCIe slot requirements>>)
