...
summary: Lustre with NetApp E-Series Storage - Software components and deployment automation overview.
---
...
[.lead]
This section provides an overview of the software components and deployment automation used in Lustre with NetApp E-Series Storage. For information about servers, storage, and networks, see link:ai-eseries-lustre-hw.html[Hardware components].
