...
image:a400-thinksystem-003.png["This graphic depicts the front of the NetApp AFF A400 storage controller."]

image:a400-thinksystem-004.png["This graphic depicts the back of the NetApp AFF A400 storage controller."]
...
image:a400-thinksystem-005.png["This image depicts an HA-pair of storage controllers containing many volumes with main files within a FlexGroup."]
...
// NetApp Solutions restructuring (jul 2025) - renamed from ai/a400-thinksystem-technology-overview.adoc
