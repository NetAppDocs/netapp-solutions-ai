...
For drive layout and volume counts, see link:ai-eseries-lustre-hw.html[Hardware components]. For deployment steps and field-level inventory guidance, see link:ai-eseries-lustre-deploy.html#phase-customize-inventory[Customize the Ansible inventory].
