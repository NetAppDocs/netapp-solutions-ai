...
image:aipod-nv-basecommand-new.png["Figure showing input/output dialog or representing written content"]
...
image:aipod-nv-ngc.png["Figure showing input/output dialog or representing written content"]
...
// NetApp Solutions restructuring (jul 2025) - renamed from ai/aipod_nv_sw_components.adoc
