...
|Intel Xeon 6th Gen (Graphite Rapids)
|2
...
Figure 3 - AIPod Mini Reference Architecture
...
image:aipod-mini-010.png[600,600]
...
For detailed deployment instructions, refer to the link:NETAPP-SOLUTIONS-AI-INTERNAL/infra/ai-aipod-mini-deployment-steps.adoc[NetApp AIpod Mini for ERAG - Deplopyment Steps]

== FAQs
Refer to the link:NETAPP-SOLUTIONS-AI-INTERNAL/infra/ai-aipod-mini-FAQs.adoc[NetApp AIPod Mini - FAQs]
