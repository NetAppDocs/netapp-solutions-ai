...
== Acknowledgment
This document is authored by Sathish Thyagarajan, Michael Oglesby and Arpita Mahajan, members of the NetApp Solutions Engineering team. The authors would also like to thank the Enterprise AI product team at Intel—Ajay Mungara, Mikolaj Zyczynski, Igor Konopko, Ramakrishna Karamsetty, Michal Prostko, Anna Alberska, Maciej Cichocki, Shreejan Mistry, Nicholas Rago and Ned Fiori-as well as other team members at NetApp—Lawrence Bunka, Bobby Oommen, and Jeff Liborio, for their continued support and help during the solution validation process.
