...
==== Deploy Enterprise RAG 2.0
Refer to the following document for complete, step-by-step deployment workflow: 
xref:ai-aipod-mini-deployment-steps.html[NetApp AIPod Mini for ERAG - Deployment Steps]
All pre-requisites, infrastructure preparation, configuration parameters and deployment procedures are documented in above deployment guide. 
...
_Note: The sizing guidance presented above is based on performance validation and test results gathered by using Intel Xeon 6 processors with 96 cores. For customers with similar I/O tokens and model size requirements we recommend using servers with Xeon 6 processors with 96 cores.
For further details on sizing guide, refer to link:https://community.intel.com/t5/Blogs/Tech-Innovation/Artificial-Intelligence-AI/Scaling-Intel-AI-for-Enterprise-RAG-Performance-64-Core-vs-96/post/1723234[Intel® AI for Enterprise RAG Sizing Guide]
...
== Acknowledgment
This document is the work of Sathish Thyagarajan, Michael Ogelsby and Arpita Mahajan, members of the NetApp Solutions Engineering team. The authors would also like to thank the Enterprise AI product team at Intel—Ajay Mungara, Mikolaj Zyczynski, Igor Konopko, Ramakrishna Karamsetty, Michal Prostko, Shreejan Mistry,Anna Alberska and Ned Fiori—and other team members at NetApp—Lawrence Bunka, Bobby Oommen, and Jeff Liborio—for their continued support and help during the validation of this solution. 
...
|Intel® Xeon® 6972P Processor 96-Core 2.40GHz 480MB Cache (500W) 
|4
...
Refer to the xref:ai-aipod-mini-infra-readiness.html[NetApp AIPod Mini - Infra Readiness] for details.
...
|Version 2.0
|Feb 2026
|Updated with OPEA-Intel® AI for Enterprise RAG 2.0
|===
