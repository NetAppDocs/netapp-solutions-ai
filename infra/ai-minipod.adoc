...
All pre-requisites, infrastructure preparation, configuration parameters and deployment procedures are documented in a separate deployment guide. 

Refer to the following document for complete, step-by-step deployment workflow: 
link:ai-aipod-mini-deployment-steps.adoc[NetApp AIPod Mini for ERAG - Deployment Steps]
