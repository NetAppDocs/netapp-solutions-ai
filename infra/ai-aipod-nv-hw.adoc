...
image:aipod-nv-a90.png["Figure showing input/output dialog or representing written content"]
...
image:aipod-nv-basepod-layers.png["Figure showing input/output dialog or representing written content"]
...
image:aipod-nv-h100-3d.png["Figure showing input/output dialog or representing written content"]
...
image:aipod-nv-h100-rear.png["Figure showing input/output dialog or representing written content"]
...
image:aipod-nv-qm9700.png["Figure showing input/output dialog or representing written content"]
...
image:aipod-nv-sn4600-hires-smallest.png["Figure showing input/output dialog or representing written content"]
...
image:aipod-nv-sn2201.png["Figure showing input/output dialog or representing written content"]
...
image:aipod-nv-cx7.png["Figure showing input/output dialog or representing written content"]
...
// NetApp Solutions restructuring (jul 2025) - renamed from ai/aipod_nv_hw_components.adoc
