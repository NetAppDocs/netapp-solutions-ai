...
image:ai-edge-012.png["Figure showing input/output dialog or representing written content"]
...
image:ai-edge-013.png["Figure showing input/output dialog or representing written content"]
...
image:ai-edge-014.png["Figure showing input/output dialog or representing written content"]
...
image:ai-edge-015.png["Figure showing input/output dialog or representing written content"]
...
image:ai-edge-016.png["Figure showing input/output dialog or representing written content"]
...
// NetApp Solutions restructuring (jul 2025) - renamed from ai/ai-edge-test-results.adoc
