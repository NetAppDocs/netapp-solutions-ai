...
image:ai-edge-005.png["Figure showing input/output dialog or representing written content"]
...
image:ai-edge-007.png["Figure showing input/output dialog or representing written content"]
...
image:ai-edge-008.png["Figure showing input/output dialog or representing written content"]

image:ai-edge-009.png["Figure showing input/output dialog or representing written content"]
...
// NetApp Solutions restructuring (jul 2025) - renamed from ai/ai-edge-technology-overview.adoc
