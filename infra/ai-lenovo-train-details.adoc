...
image:a400-thinksystem-008.png[This figure shows the Aggregate Images per second.]

image:a400-thinksystem-009.png[This figurwe shows the Runtime in minutes.]
...
// NetApp Solutions restructuring (jul 2025) - renamed from ai/a400-thinksystem-test-procedure-and-detailed-results.adoc
