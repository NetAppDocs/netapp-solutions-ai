...
image:ef-superpod-highlevel.png["Figure showing a high-level overview of the NetApp BeeGFS solution with a NVIDIA DGX SuperPOD."]
...
image:ef-superpod-buildingblock.png["Figure showing a single NetApp BeeGFS Building Block."]
...
// NetApp Solutions restructuring (jul 2025) - renamed from ai/ai-dgx-superpod.adoc
