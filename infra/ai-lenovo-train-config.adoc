...
image:a400-thinksystem-007.png["This graphic depicts the compute layer, a Lenovo ThinkSystem SR670 V2, the network layer, a Lenovo Ethernet switch, and the storage layer, a NetApp AFF A400 storage controller. All network connections are included."]
...
// NetApp Solutions restructuring (jul 2025) - renamed from ai/a400-thinksystem-test-configuration.adoc
