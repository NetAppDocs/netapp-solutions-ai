...
image:ai-edge-010.png["Figure showing input/output dialog or representing written content"]
...
image:ai-edge-011.png["Figure showing input/output dialog or representing written content"]


// NetApp Solutions restructuring (jul 2025) - renamed from ai/ai-edge-test-configuration.adoc
