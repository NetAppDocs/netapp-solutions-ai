...
image:ai-edge-002.png["Figure showing input/output dialog or representing written content"]

image:ai-edge-017.png["Figure showing input/output dialog or representing written content"]
...
image:ai-edge-003.png["Figure showing input/output dialog or representing written content"]
...
// NetApp Solutions restructuring (jul 2025) - renamed from ai/ai-edge-introduction.adoc
